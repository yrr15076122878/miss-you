...
var main = {
    ...
    alertAddCard: function (dtList) {
        ...
        var htmlCont = '<div class="badge-box center-block" id="page1">' +
           ...
           '<div class="cont-box pre">' + pre + '</div>'+
        ...
        $(".pre").show();
        main.fontAutoSize('.badge-box', '.card_name span', fontSize.nameMinFontSize, arr[2]);
        //main.fontAutoSize('.badge-box', '.card_position span', fontSize.companyMinFontSize, arr[1]);
        main.fontAutoSize('.badge-box', '.card_company span', fontSize.companyMinFontSize, arr[4]);
