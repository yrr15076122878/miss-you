...
var visitMain = {
    ...
    start: function () {
        ...
        //visitMain.drawCard("null","11111@222@33333@44444@5555@6666@7777");
    ...
    clearContent: function () {
        var getBarcode = $(".getBarcode").val();
        $('.form-group input').val("");  //点击确定清空内容
        $(".getBarcode").val(getBarcode);
        ...
        $(".card_name div,.card_position div,.card_company div,.card_country_province div,.card_boothNum div").html("");//card_category
    },
    ...
    drawCard: function (me, dataLs) {   //绘制胸卡
        ...
        if (me == 'null') {
            ...
            Pum.textAdaptation({LineNumber:1,event:-1,autoWrap:true,text:arr[3],pElem:'.card_company',dElem:'.card_company div',minF:fontSize.companyMinFontSize});
            Pum.textAdaptation({LineNumber:1,event:-1,autoWrap:true,text:arr[4],pElem:'.card_boothNum',dElem:'.card_boothNum div',minF:fontSize.boothNumMinFontSize});
            //Pum.textAdaptation({LineNumber:1,event:-1,autoWrap:true,text:arr[1],pElem:'.card_position',dElem:'.card_position div',minF:fontSize.companyMinFontSize});
            //Pum.textAdaptation({LineNumber:1,event:-1,autoWrap:true,text:arr[7] + ' / '+arr[6],pElem:'.card_country_province',dElem:'.card_country_province div',minF:fontSize.companyMinFontSize});
            ...
            var htmlCont = '<div class="badge-box center-block" id="page1">' +
                '<div class="cont-box card_name">' + $(me).children('td').eq(visitMain.nameIndex).html() + '</div>' +
                '<div class="cont-box card_company">' + $(me).children('td').eq(visitMain.companyIndex).html() + '</div>' +
