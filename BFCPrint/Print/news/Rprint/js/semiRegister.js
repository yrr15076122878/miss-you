var main = {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $('.carder_box,.carder_box_repeat').html(""); //移除卡片
                      ...
                      //main.dataTables([
                      //    { "printStatus": "0","ChineseName": "傅啸龙", 'EnglishName': '	FuXiaolong', "ChineseCompany": "广州汽车集团股份有限公司汽车工程研究院", "company": "GAC Automotive Engineering Institute", "DocumentType": "会议代表 Delegate", "barcode": "SAECCE1517","note":"备注","Business":"G","DinnerType":"LT","Meal":"Meal" },
                      //    { "printStatus": "0","ChineseName": "李涛", 'EnglishName': 'JINPINGFAN', "ChineseCompany": "广州汽车集团股份有限公司汽车工程研究院", "company": "GUANGZHOU AUTOMOBILE GROUP CO.,LTD AUTOMOTIVE ENGINEERING INSTITUTE ", "DocumentType": "会议代表 Delegate", "barcode": "SAECCE1393","note":"备注","Business":"G","DinnerType":"LT","Meal":"Meal"},
                      //    { "printStatus": "0","ChineseName": "连学通", 'EnglishName': 'litao', "ChineseCompany": "科必睿信息技术（上海）有限公司R", "company": "The Automotive Engineering Institute of Guangzhou Automobile Group Co., Ltd. (GAC ENGINEERING)", "DocumentType": "会议代表 Delegate", "barcode": "SAECCE1393","note":"备注","Business":"G","DinnerType":"LT","Meal":"Meal"},
                      //    { "printStatus": "0","ChineseName": "杨荣山", 'EnglishName': 'lixin', "ChineseCompany": "科必睿信息技术（上海）有限公司", "company": "GAC R&D", "DocumentType": "会议代表 Delegate", "barcode": "SAECCE1393","note":"备注","Business":"G","DinnerType":"LT","Meal":"Meal"},
                      //    { "printStatus": "0","ChineseName": "叶树斌", 'EnglishName': 'Wang Bo', "ChineseCompany": "广州汽车集团股份有限公司汽车工程研究院", "company": "GAC R&D CENTER", "DocumentType": "会议代表 Delegate", "barcode": "SAECCE1393","note":"备注","Business":"G","DinnerType":"LT","Meal":"Meal"}]);
    ...
    drawCard: function (me) {   //绘制胸卡
        ...
        var typeText = $(me).children('td').eq(main.typeIndex).text();
   		var BusinessText = $(me).children('td').eq(main.BusinessIndex).text();
        var DinnerTypeText = $(me).children('td').eq(main.DinnerTypeIndex).text();
        var htmlCont = '<div class="badge-box-bg">' +
            ...
            '<div class="cont-box card_barcode"><div id="jQBarcode"></div></div>' +
             '<div class="cont-box card_Business"><span class="Business_span"></span></div>'+
            '<div class="cont-box card_DinnerType"><span class="DinnerType_span"></span></div>' +
        ...
        main.fontAutoSize('.card_Ccompany', '.card_Ccompany span', fontSize.companyMinFontSize, CcompanyText);
       	main.fontAutoSize('.card_Business','.card_Business span', fontSize.BDMinFontSize, BusinessText);
        main.fontAutoSize('.card_DinnerType','.card_DinnerType span', fontSize.BDMinFontSize, DinnerTypeText);
