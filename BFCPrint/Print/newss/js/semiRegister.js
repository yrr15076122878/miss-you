var main = {
	...
	start: function() {
		...
		//main.dataTables([{
		//	"fname": "邵周鹏",
		//	'Jobtitle': 'corporate IT solutuions (shanghai) co., ltd',
		//	"category": "媒体 PRESS",
		//	"printStatus": "0",
		//	"company": "农产品市场周刊农产品市场周刊农产品市场周刊",
		//	"barcode": "1000029"
		//}, {
		//	"fname": "蒋学周",
		//	"category": "主办单位 ORGANIZER",
		//	"printStatus": "0",
		//	"company": "漯河市召陵区农林局 ",
		//	"barcode": "3100863"
		//}, {
		...
		//	"printStatus": "0",
		//	"company": "金周科技(上海)有限公司",
		//	"barcode": "5000484"
		//}, {
		//	"fname": "卢周锋",
		//	"category": "专业观众 TRADE VISITOR",
		//	"printStatus": "0",
		//	"company": "西安耀天生化科技有限公司",
		//	"barcode": "5000229"
		//}, {
		//	"fname": "邵周鹏",
		//	"category": "专业观众 TRADE VISITOR",
		//	"printStatus": "0",
		//	"company": "香格里拉圣宝食品进出口有限责任公司",
		//	"barcode": "2102375"
		//},
		// {
		//	"fname": "邵周鹏",
		//	"category": "观众 spectator",
		//	"printStatus": "0",
		//	"company": "香格里拉圣宝食品进出口有限责任公司",
		//	"barcode": "2102376"
		//},
	...
	drawCard: function(me) { //绘制胸卡
		...
		Pum.textAdaptation({
			...
			text: companyTetx,
			pElem: '.card_company',
			dElem: '.card_company div',
			minF: fontSize.companyMinFontSize
		});
		...
		Pum.textAdaptation({
			...
			text: category,
			pElem: '.card_category',
			dElem: '.card_category div',
			minF: fontSize.categoryMinFontSize
		});
		...
		$('#jQBarcode').ready(function() { //当svg加载出来开始绘制条码
			...
			$('#jQBarcode').barcode(jQBarcode, "code128", {
				barHeight: 30
			});
			if(pretext === "Pre") {
...
//				// printer: '联想激打',
//				copies: 1, //打印份数
//				paperWidth: 1000, //设置打印的宽度
//				paperHeight: 600, //设置打印的高度
//				topMargin: 0,
//				leftMargin: 0,
//				bottomMargin: 0,
//				rightMargin: 0
